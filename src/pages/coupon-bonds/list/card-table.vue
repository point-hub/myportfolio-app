...
const {
  ...
  columns: {
    ...
    'coupon_disbursement_bank': { label: 'Coupon Payment Bank', isVisible: true, isSelectable: true },
    'coupon_disbursement_bank_account_number': { label: 'Coupon Payment Account Number', isVisible: true, isSelectable: true },
    'coupon_disbursement_bank_account_name': { label: 'Coupon Payment Account Name', isVisible: true, isSelectable: true },
    'coupon_disbursement_date': { label: 'Coupon Payment Date', isVisible: true, isSelectable: true },
    'coupon_disbursement_amount': { label: 'Coupon Payment Amount', isVisible: true, isSelectable: true },
