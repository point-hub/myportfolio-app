...
<template>
  <base-card title="Interest Info">
    <div class="flex flex-col gap-4 my-5">
      ...
      <base-input-number layout="h" label="Tax Rate" align="left" required v-model="data.interest.tax_rate" :errors="errors['interest.tax_rate']" :disabled="isSaving" decimal-length="4" />
      <base-input-number layout="h" label="Tax Amount" align="left" required :model-value="taxAmount" :errors="errors['interest.tax_amount']" disabled decimal-length="4" />
