...
import { deleteCashbackDepositApi } from '@/composables/api/deposits/delete-cashback.api';
...
const onReceive = async () => {
  ...
  try {
    await receiveCashbackDepositApi(data.value._id as string, {
...
const onDelete = async () => {
  ...
  try {
    await deleteCashbackDepositApi(data.value._id as string, {
      uuid: data.value?.uuid,
    });
