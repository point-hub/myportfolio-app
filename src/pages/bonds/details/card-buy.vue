...
<template>
  <base-card title="Buy Information">
    <div class="flex flex-col gap-4 my-5">
      ...
      <base-input-number layout="horizontal" label="Coupon Rate" align="left" required v-model="data.coupon_rate" :errors="errors.coupon_rate" disabled decimal-length="3" />
      <base-input-number layout="horizontal" label="Coupon Tenor" align="left" required v-model="data.coupon_tenor" :errors="errors.coupon_tenor" disabled decimal-length="3" />
