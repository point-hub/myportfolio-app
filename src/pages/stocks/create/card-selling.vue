    ...
    <base-table class="min-h-48">
      ...
      <tbody>
        <tr v-for="(selling, index) in data?.selling_list">
          ...
          <td><base-input-number v-model="selling.lots" :errors="errors?.[`selling_list.${index}.lots`]" :disabled="isSaving" decimal-length="4" border="none" paddingless /></td>
          <td><base-input-number :model-value="selling.shares" :errors="errors?.[`selling_list.${index}.shares`]" disabled decimal-length="4" border="none" paddingless /></td>
          <td><base-input-number v-model="selling.price" :errors="errors?.[`selling_list.${index}.price`]" :disabled="isSaving" decimal-length="4" border="none" paddingless /></td>
          <td><base-input-number v-model="selling.total" :disabled="isSaving" decimal-length="4" border="none" paddingless /></td>
          <td>
