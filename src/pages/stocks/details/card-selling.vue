    ...
    <base-table class="min-h-48">
      ...
      <tbody>
        <tr v-for="(selling, index) in data?.selling_list">
          ...
          <td><base-input-number v-model="selling.lots" disabled decimal-length="4" border="none" paddingless /></td>
          <td><base-input-number :model-value="selling.shares" disabled decimal-length="4" border="none" paddingless /></td>
          <td><base-input-number v-model="selling.price" disabled decimal-length="4" border="none" paddingless /></td>
          <td><base-input-number v-model="selling.total" disabled decimal-length="4" border="none" paddingless /></td>
        </tr>
      </tbody>
    </base-table>
  </base-card>
