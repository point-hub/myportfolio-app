        ...
        <tbody>
          ...
          <template v-if="!isLoading && stocks && stocks.length > 0">
            <tr v-for="(stock, index) in stocks" :key="index" :class="{'bg-red-50 dark:bg-red-800': stock.status === 'draft'}">
              ...
              <td v-if="columns['buying_total']?.isVisible">{{ formatNumber(stock.buying_total, 3) }}</td>
              <td v-if="columns['buying_brokerage_fee']?.isVisible">{{ formatNumber(stock.buying_brokerage_fee, 3) }}</td>
              <td v-if="columns['buying_vat']?.isVisible">{{ formatNumber(stock.buying_vat, 3) }}</td>
              <td v-if="columns['buying_levy']?.isVisible">{{ formatNumber(stock.buying_levy, 3) }}</td>
              <td v-if="columns['buying_kpei']?.isVisible">{{ formatNumber(stock.buying_kpei, 3) }}</td>
              <td v-if="columns['buying_stamp']?.isVisible">{{ formatNumber(stock.buying_stamp, 3) }}</td>
              <td v-if="columns['buying_proceed']?.isVisible">{{ formatNumber(stock.buying_proceed, 3) }}</td>
              <td v-if="columns['selling_total']?.isVisible">{{ formatNumber(stock.selling_total, 3) }}</td>
              <td v-if="columns['selling_brokerage_fee']?.isVisible">{{ formatNumber(stock.selling_brokerage_fee, 3) }}</td>
              <td v-if="columns['selling_vat']?.isVisible">{{ formatNumber(stock.selling_vat, 3) }}</td>
              <td v-if="columns['selling_levy']?.isVisible">{{ formatNumber(stock.selling_levy, 3) }}</td>
              <td v-if="columns['selling_kpei']?.isVisible">{{ formatNumber(stock.selling_kpei, 3) }}</td>
              <td v-if="columns['selling_stamp']?.isVisible">{{ formatNumber(stock.selling_stamp, 3) }}</td>
              <td v-if="columns['selling_proceed']?.isVisible">{{ formatNumber(stock.selling_proceed, 3) }}</td>
              <td v-if="columns['proceed_amount']?.isVisible">{{ formatNumber(stock.proceed_amount, 3) }}</td>
