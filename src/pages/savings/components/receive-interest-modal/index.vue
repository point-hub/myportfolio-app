...
import { deleteInterestSavingApi } from '@/composables/api/savings/delete-interest.api';
import { receiveInterestSavingApi } from '@/composables/api/savings/receive-interest.api';
...
const onReceive = async () => {
  ...
  try {
    await receiveInterestSavingApi(data.value._id as string, {
...
const onDelete = async () => {
  ...
  try {
    await deleteInterestSavingApi(data.value._id as string, {
      uuid: data.value?.uuid,
    });
