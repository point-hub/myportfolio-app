...
import { deleteCashbackSavingApi } from '@/composables/api/savings/delete-cashback.api';
import { receiveCashbackSavingApi } from '@/composables/api/savings/receive-cashback.api';
...
const onReceive = async () => {
  ...
  try {
    await receiveCashbackSavingApi(data.value._id as string, {
...
const onDelete = async () => {
  ...
  try {
    await deleteCashbackSavingApi(data.value._id as string, {
      uuid: data.value?.uuid,
    });
