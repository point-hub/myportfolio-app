...
const {
  ...
  columns: {
    'interest_schedule.status': { label: 'Status', isVisible: true, isSelectable: false },
    'placement.bilyet_number': { label: 'Bilyet Number', isVisible: true, isSelectable: true },
    'interest_schedule.payment_date': { label: 'Payment Date', isVisible: true, isSelectable: false },
    'interest_schedule.received_date': { label: 'Received Date', isVisible: true, isSelectable: false },
    'interest_schedule.received_additional_payment_date': { label: 'Received Additional Payment Date', isVisible: true, isSelectable: false },
    'interest_schedule.amount': { label: 'Interest Amount', isVisible: true, isSelectable: false },
    'interest_schedule.received_amount': { label: 'Received Amount', isVisible: true, isSelectable: false },
    'interest_schedule.received_additional_payment_amount': { label: 'Received Additional Payment Amount', isVisible: true, isSelectable: false },
    'interest_schedule.remaining_amount': { label: 'Remaining Amount', isVisible: true, isSelectable: false },
    'interest_schedule.bank.name': { label: 'Bank Name', isVisible: true, isSelectable: false },
    'interest_schedule.bank.account.account_name': { label: 'Bank Account Name', isVisible: true, isSelectable: false },
    'interest_schedule.bank.account.account_number': { label: 'Bank Account Number', isVisible: true, isSelectable: false },
    'interest_schedule.additional_bank.name': { label: 'Additional Bank Name', isVisible: true, isSelectable: false },
    'interest_schedule.additional_bank.account.account_name': { label: 'Additional Bank Account Name', isVisible: true, isSelectable: false },
    'interest_schedule.additional_bank.account.account_number': { label: 'Additional Bank Account Number', isVisible: true, isSelectable: false },
    'interest_schedule.created_by.username': { label: 'Created By', isVisible: true, isSelectable: false },
          ...
          <template v-if="!isLoading && deposits && deposits.length > 0">
            <template v-for="(deposit, index) in deposits" :key="index">
              <tr>
                ...
                <td v-if="columns['interest_schedule.status']?.isVisible" class="text-center">
                  <base-button
                    ...
                    v-if="!deposit.interest_schedule?.received_date"
                    variant="filled"
                    color="primary"
                  >
