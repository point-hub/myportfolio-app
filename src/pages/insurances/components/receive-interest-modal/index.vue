...
import { deleteInterestInsuranceApi } from '@/composables/api/insurances/delete-interest.api';
import { receiveInterestInsuranceApi } from '@/composables/api/insurances/receive-interest.api';
...
const onReceive = async () => {
  ...
  try {
    await receiveInterestInsuranceApi(data.value._id as string, {
...
const onDelete = async () => {
  ...
  try {
    await deleteInterestInsuranceApi(data.value._id as string, {
      uuid: data.value?.uuid,
    });
