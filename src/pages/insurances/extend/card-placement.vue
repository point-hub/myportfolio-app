...
<template>
  <base-card title="Placement">
    <div class="flex flex-col gap-4">
      ...
      />
      <base-input layout="h" label="Policy Number" required v-model="data.placement.policy_number" :errors="errors['placement.base_date']" disabled />
      ...
      <base-datepicker layout="h" label="Placement Date" required v-model="data.placement.date" :errors="errors['placement.date']" disabled description="Placement Date" />
      ...
      <base-input-number layout="h" label="Amount" align="left" required v-model="data.placement.amount" :errors="errors['placement.amount']" disabled />
    </div>
  </base-card>
</template>
